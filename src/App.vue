  ...
  <div class="flex flex-col min-h-screen">
    ...
    <footer class="bg-[#1A1A1A] text-white py-12">
      <div class="container mx-auto px-4 sm:px-6">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li v-for="(link, index) in links" :key="index">
                <RouterLink :to="link.to" class="hover:text-purple-400 transition-colors">{{
                  link.text
                }}</RouterLink>
              </li>
              <li>
        ...
        <!-- Bottom Bar -->
        <div
          class="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400"
        >
