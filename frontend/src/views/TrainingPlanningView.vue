...
const { data: weekSchedule } = useApiList<WeekSchedule>('/training-schedules')
...
const selectedWeekPeriod = computed(() => weekSchedule.value[selectedWeekIndex.value]?.period)
</script>
...
<template>
  ...
  >
    <div class="max-w-7xl mx-auto">
      ...
      <p
        v-if="selectedWeekPeriod"
        class="text-center text-mutedText dark:text-mutedText-dark mb-8 -mt-4"
      >
        {{ selectedWeekPeriod }}
      </p>
